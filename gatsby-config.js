...
module.exports = {
  siteMetadata: {
    ...
    siteUrl: 'https://www.tejeshwargill.com', // No trailing slash allowed!
  ...
  plugins: [
    ...
    // Replaced `gatsby-plugin-offline` with this so any previously-cached
    // service worker unregisters itself and content updates show immediately.
    ...
    // To enable Google Analytics, install `gatsby-plugin-google-analytics`
    // and add a block here with your own `trackingId`.
  ],
};
